...
<div class="container-wrap">
    <form class="form-horizontal" role="form" action="${ctx}/update" method="post">
       <input id="id" name="studentId" value="${student.studentId}" hidden="hidden">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" id="gradeId" name="gradeId" value="${student.gradeId}">
            </div>
        </div>
        <div class="form-group">
